package com.tracfone.twist.walmart;
...
public class Registration {
	...
	private ResourceBundle props = ResourceBundle.getBundle("Tracfone");
	...
	public void registerIphoneModelForCarrier(String model, String simPart)
			throws Exception {
		String imei = registeriphone(model, simPart);
	}
	

	public String registeriphone(String model, String simPart) {
		...
		oRequest.setBrandName(TracfoneBrandType.TRACFONE);
		...
		Assert.assertEquals(oResp.getResult().getMessage(), "SUCCESS", oResp.getResult().getMessage());
//		String phonePartNum = phoneUtil.getPhonePartNumberbySimandModel(model,simPart);
